...
const integrationSeed:Array<Pick<Integration,'name'|'description'|'authType'|'riskLevel'>>=[
 ...
 {name:'Gmail',description:appMode.allowsDemoData?'Mock connected / backend-ready. Prototype mode reviews sample mail, creates reports, extracts actions, and drafts replies for approval before any future send.':'Mock connected / backend-ready. No real Gmail account is connected; production-preview starts without sample inbox data.',authType:'Future OAuth / server secret',riskLevel:'high'},
 {name:'Google Calendar',description:appMode.allowsDemoData?'Mock connected / backend-ready. Prototype mode reviews sample calendar events, prepares meeting briefings, and queues event action approvals before any future create/update/invite/send.':'Mock connected / backend-ready. No real Google Calendar account is connected; production-preview starts without sample event data.',authType:'Future OAuth / server secret',riskLevel:'high'},
