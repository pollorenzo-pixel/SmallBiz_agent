...
export function App() {
 ...
 useEffect(()=>{if(!appMode.allowsDemoData&&(page==='community'||page==='agents'))setPage('home')},[page])
 ...
 if(!appMode.allowsDemoData&&(page==='community'||page==='agents'))return null
