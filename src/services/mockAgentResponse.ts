...
import type { AgentOutput, Approval, MockAgentResult, PermissionLevel, RiskLevel, SkillGapReport } from '../types'
...
export function generateMockAgentResponse(prompt:string, preferredAgentId?:string):MockAgentResult {
