...
const prototypeNav: {id:PageId; label:string; icon:string}[] = [
  {id:'home',label:'Today',icon:'⌂'},{id:'workspace',label:'Projects',icon:'▦'},{id:'community',label:'Community',icon:'♡'},{id:'agents',label:'Agents',icon:'◎'},{id:'workflows',label:'Workflows',icon:'↗'},
...
export function Shell({ page, setPage, pending, children }:{page:PageId; setPage:(p:PageId)=>void; pending:number; children:ReactNode}) {
  return <div className="app-shell">
    <aside className="sidebar">
      <button className="brand" onClick={()=>setPage('home')}><span className="brand-mark">S</span><span><b>SmallBiz OS</b><small>Founder Operating System</small></span></button>
